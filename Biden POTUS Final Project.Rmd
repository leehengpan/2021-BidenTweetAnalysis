...
綜合各情緒類別的字詞組成，可以發現出現頻率較高且具備政策意涵的詞彙有:
...
即使資料擷取時間有涵蓋總統選舉期間，`@JoeBiden`除了選舉詞彙與人物詞彙之外(例如`president/vote/trump`)還是多使用模糊字眼。可以推論相較`@POTUS`，`@JoeBiden`更加的情緒化，而不傾向呈現具體政策意涵或社會事件。
